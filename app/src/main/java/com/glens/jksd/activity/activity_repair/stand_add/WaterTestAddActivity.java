 ...
 * 新增憎水性实验
 */
public class WaterTestAddActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener, RepairTowerAddView {
    public static final String TAG = WaterTestAddActivity.class.getSimpleName();
    ...
    EditText repairLoc;
    @Bind(R.id.et_text_conclusion)
    EditText mEtConclusion;
    ...
    @Bind(R.id.fy_water_test)
    FrameLayout fyWaterTest;
    ...
    private static final int REQUEST_CHECK_PIC = 115;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water_test_add);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (parent.getId()) {
            case R.id.grid_view:
                ...
                ImagePickUtils.promptSelectImgDialog(event, position, WaterTestAddActivity.this, mImageList, REQUEST_CHECK_PIC, 4, R.id.fy_water_test);
    ...
    private void initView() {
        setTitleText(R.string.repair_water_test);
    ...
    private void initNetData() {
        ...
        mPresenter = new RepairGetMapPresenter(WaterTestAddActivity.this);
        mPresenter.onCreate();
        mPresenter.BindPresentView(WaterTestAddActivity.this);
    ...
    public HashMap<String, Object> getDataMap() {
        ...
        map.put("testConclusion",mEtConclusion.getText().toString().trim());
    ...
    public void onEventMainThread(BaseEvent event) {
        ...
        switch (event.getEventType()) {
            case RepairConstantUtils.NET_POST_DETECTION_IMAGE:
                ...
                mPresenter.upWaterTestPhoto(PowerApplication.getmDataList().get(0).sourcePath, mTaskCode, "测试");
                break;
            ...
            case RepairConstantUtils.DELETE_IMAGE_SUCCESS:
                if (!TextUtils.isEmpty(picCode)) {
                    ...
                    mPresenter.deleteWaterTestPhoto(picCode);
                }
                break;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.repair_equipment:
                mPresenter.changeToSelect(mTaskCode, RepairConstantUtils.LINE_SPRAY, WaterTestAddActivity.this);
                break;
            case R.id.repair_task_standard_ry:
                if (mPresenter.checkWaterTestData(this, lineName, lineNumber, lineNumber, selectText, repairLoc,mEtConclusion.getText().toString().trim())) {
                    mPresenter.addWaterTest();
                }
                break;
        }
    }
