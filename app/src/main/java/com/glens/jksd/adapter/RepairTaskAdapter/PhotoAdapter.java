...
public class PhotoAdapter extends BaseAdapter {
    ...
    private List<InformationDetailBean.PicListBean> mImageInfoList;

    public PhotoAdapter(Context context, List<InformationDetailBean.PicListBean> appImageInfoList) {
