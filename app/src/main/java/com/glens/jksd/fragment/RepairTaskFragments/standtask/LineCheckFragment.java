...
import com.glens.jksd.activity.activity_repair.stand_add.RepairLineCheckActivity;
import com.glens.jksd.activity.activity_repair.stand_detail.TraceCheckDetailActivity;
 ...
 * 走线检查
 */
public class LineCheckFragment extends BaseFragment implements RepairTowerCheckView {
    public static final String TAG = LineCheckFragment.class.getSimpleName();
    ...
    protected View initView() {
        ...
        mRepairTaskStandardText.setText("新增走线检查");
    ...
    private void initNetData() {
        ...
        mPresenter.traceCheckList("", "", mTaskCode);
    }
    ...
    private void changeToRepairTaskItemActivity(String checkRecordCode) {
        Intent intent = new Intent(getActivity(), TraceCheckDetailActivity.class);
    ...
    public void setTimeTaskSearch(String startTime, String endTime) {
        mPresenter.traceCheckList(startTime, endTime, mTaskCode);
    }
    ...
    private void changeToTowerAdd() {
        Intent intent = new Intent(getActivity(), RepairLineCheckActivity.class);
        startActivity(intent);
    }
