...
import com.glens.jksd.activity.activity_repair.stand_add.RepairAddSprayActivity;
import com.glens.jksd.activity.activity_repair.stand_detail.SprayDetailActivity;
 ...
 * 新增Rtv喷涂
 */
public class RtvSparyFragment extends BaseFragment implements RepairTowerCheckView {

    public static final String TAG = RtvSparyFragment.class.getSimpleName();
    ...
    protected View initView() {
        ...
        mRepairTaskStandardText.setText("新增RTV喷涂");
    ...
    private void initNetData() {
        ...
        mPresenter.rtvSprayList("", "", mTaskCode);
    }
    ...
    private void changeToRepairTaskItemActivity(String checkRecordCode) {
        Intent intent = new Intent(getActivity(), SprayDetailActivity.class);
    ...
    private void changeToTowerAdd() {
        Intent intent = new Intent(getActivity(), RepairAddSprayActivity.class);
        startActivity(intent);
    }
