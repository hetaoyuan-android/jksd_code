...
import com.glens.jksd.activity.activity_repair.stand_add.WaterTestAddActivity;
import com.glens.jksd.activity.activity_repair.stand_detail.WaterTestDetailActivity;
 ...
 *  憎水性实验
 */
public class WaterTestFragment extends BaseFragment implements RepairTowerCheckView {
    public static final String TAG = WaterTestFragment.class.getSimpleName();
    ...
    protected View initView() {
        ...
        mRepairTaskStandardText.setText("新增憎水性实验");
    ...
    private void initNetData() {
        ...
        mPresenter.hydrophobicTestList("", "", mTaskCode);
    }
    ...
    private void changeToRepairTaskItemActivity(String checkRecordCode) {
        Intent intent = new Intent(getActivity(), WaterTestDetailActivity.class);
    ...
    private void changeToTowerAdd() {
        Intent intent = new Intent(getActivity(), WaterTestAddActivity.class);
        startActivity(intent);
    }
