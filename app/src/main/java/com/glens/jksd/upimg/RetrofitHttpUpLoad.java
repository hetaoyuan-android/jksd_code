...
public class RetrofitHttpUpLoad {
    ...
    public <T> void addToEnqueue(Call<T> call, final RetrofitCallBack retrofitCallBack, final int method) {
        final Context context = PowerApplication.getContext();
    ...
    public RetrofitHttpUpLoad addParameter(String key, Object o) {
        ...
        if (o instanceof String) {
            RequestBody body = RequestBody.create(MediaType.parse("multipart/form-data"), (String) o);
            params.put(key, body);
        } else if (o instanceof File) {
            RequestBody body = RequestBody.create(MediaType.parse("multipart/-formdata"), (File) o);
