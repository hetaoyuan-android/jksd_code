...
//
//    //设置加载中以及加载失败图片并且指定大小
//    public static void loadImageViewLoadingSize(Context mContext, String path, int width, int height, ImageView mImageView, int errorImageView) {
//        Glide.with(mContext).load(path).override(width, height).error(errorImageView).into(mImageView);
//    }
//
//    //设置图片以及加载失败图片
//    public static void loadImageViewOrError(Context mContext, String path, ImageView mImageView, int errorImageView) {
